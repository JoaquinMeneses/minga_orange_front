      ...
      <div className="min-h-screen bg-black">
        ...
        <main id="Home">
          ...
          <div className="h-[100vh] flex">
            <div className="h-[60%] w-[50%] z-[0] rounded-full bg-black absolute left-0"></div>
            <div className="h-[100%] w-[50%] z-[0] rounded-full bg-gradient-to-r from-black to-indigo-600 blur-[115px] absolute right-0"></div>
            <div className="h-[100%] w-[50%] z-[1] md:flex md:justify-center">
              <img src={MangasHome} alt="" />
            </div>
            <div className="h-[80%] w-[50%] z-[1] md:flex md:flex-col md:items-center md:justify-center">
              <h1 className="text-white mb-4 font-semibold text-5xl not-italic w-[70%]">Your favourite manga reader 😏</h1>
              <p className="text-white mb-4 font-normal text-base not-italic w-[70%]">Is an exceptional app for all manga lovers. With a wide range of titles available, from classics to the latest releases, this app is perfect for those who want to read manga anytime, anywhere.</p>
              <button class="flex w-[70%] mb-4 align-center justify-center bg-white/30 backdrop-blur-sm rounded-[5px] text-white text-center py-[0.5rem] px-4">
                ...
                <span class="text-base w-[100%]">Search a manga</span>
              </button>
            </div>
          </div>
        </main>
        <footer className="bg-white text-black">
          ...
          <div className="flex justify-between flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
            <ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:justify-start">
              <a className="mx-[0.5rem] md:m-0" href="#Home">Home</a>
              <a className="mx-[0.5rem] md:m-0" href="#Mangas">Mangas</a>
            </ul>
            ...
            <div className="flex flex-col justify-center pt-6 lg:pt-0">
              <div className="flex justify-center space-x-4">
                <a rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:text-gray-900">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z" /></svg>
                </a>
                <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:text-gray-900">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
                </a>
                <a rel="noopener noreferrer" href="#" title="Vimeo" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:text-gray-900">
